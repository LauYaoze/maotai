 ...
 * 环境变量：export MT_CITY="天津市"  // 城市
 * 环境变量：export MT_DISTRICT="河北区"  // 需要申购的区域，多个区域以 | 隔开，留空为随机申购全市所有门店
 * 环境变量：export MT_ITEM_BLACK="2478|10056"  // 申购商品ID黑名单，多个ID以 | 隔开，留空为随机申购所有商品
 * 环境变量：export MT_VERSION="1.5.7"  // APP版本号 非必填
 * 环境变量：export MT_USERAGENT="iOS;16.7.2;Apple;?unrecognized?"  // User-Agent 非必填
...
i 茅台 = type=cron,cronexp=1 9 * * *,timeout=60,script-path=https://raw.githubusercontent.com/gaoyukai/reservation-maotai-script/main/i-maotai.js,script-update-interval=0
...
cron "1 9 * * *" script-path=https://raw.githubusercontent.com/gaoyukai/reservation-maotai-script/main/i-maotai.js,tag = i 茅台,enable=true
...
[task_local]
1 9 * * * https://raw.githubusercontent.com/gaoyukai/reservation-maotai-script/main/i-maotai.js, tag=i 茅台, enabled=true
...
let MT_PROVINCE = $.getdata('MT_PROVINCE') || '天津市';
let MT_CITY = $.getdata('MT_CITY') || '天津市';
